...
import OverlayX from "../mainComponents/OverlayX";
import photo from "../aboutSection/AboutMePhoto.jpg";

const AboutSection = () => {
  return (
    <section className="relative py-20 my-20 rounded-lg shadow-lg bg-white overflow-hidden">
            ...
            <div className="max-w-lg mx-auto lg:mx-0">
              ...
              <OverlayX delay={0.3}>
                <p className="text-lg text-gray-600 mb-6">
                  ...
                  neque dolores cum error illum inventore, unde deserunt nisi
                  doloribus, quos suscipit quibusdam temporibus ea ducimus
                  minima architecto dicta quia atque?
                </p>
              </OverlayX>
              <div className="mb-8">
